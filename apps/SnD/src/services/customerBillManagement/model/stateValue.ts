 ...
 * 
 */
export type StateValue = 'new' | 'onHold' | 'validated' | 'sent' | 'partiallyPaid' | 'settled';

export const StateValue = {
    New: 'new' as StateValue,
    OnHold: 'onHold' as StateValue,
    Validated: 'validated' as StateValue,
    Sent: 'sent' as StateValue,
    PartiallyPaid: 'partiallyPaid' as StateValue,
    Settled: 'settled' as StateValue
}
