...
import {AppliedCustomerBillingRate} from '../model/appliedCustomerBillingRate';
import MasterConfigService from '../../master/api/MasterConfigService';

export default class AppliedCustomerBillingRateService {
     ...
     */
    public listAppliedCustomerBillingRate(
        fields?: string,
        offset?: number,
        limit?: number,
        observe?: 'body',
        headers?: Headers
    ): Observable<Array<AppliedCustomerBillingRate>>;
    public listAppliedCustomerBillingRate(
        fields?: string,
        offset?: number,
        limit?: number,
        observe?: 'response',
        headers?: Headers
    ): Observable<HttpResponse<Array<AppliedCustomerBillingRate>>>;
    public listAppliedCustomerBillingRate(
        fields?: string,
        offset?: number,
        limit?: number,
        ...
        const response: Observable<
            HttpResponse<Array<AppliedCustomerBillingRate>>
        > = this.httpClient.get(
            `${
                this.APIConfiguration.basePath
            }/appliedCustomerBillingRate?${queryParameters.join('&')}` as any,
            headers
        );
        if (observe === 'body') {
     ...
     * @param id Identifier of the AppliedCustomerBillingRate
     * @param fields Comma-separated properties to provide in response
     
     */
    public retrieveAppliedCustomerBillingRate(
        id: string,
        fields?: string,
        observe?: 'body',
        headers?: Headers
    ): Observable<AppliedCustomerBillingRate>;
    public retrieveAppliedCustomerBillingRate(
        id: string,
        fields?: string,
        observe?: 'response',
        headers?: Headers
    ): Observable<HttpResponse<AppliedCustomerBillingRate>>;
    public retrieveAppliedCustomerBillingRate(
        id: string,
        fields?: string,
        observe: any = 'body',
        ...
        if (!id) {
            throw new Error(
                'Required parameter id was null or undefined when calling retrieveAppliedCustomerBillingRate.'
            );
        }
        ...
        const response: Observable<HttpResponse<AppliedCustomerBillingRate>> =
            this.httpClient.get(
                `${
                    this.APIConfiguration.basePath
                }/appliedCustomerBillingRate/${encodeURIComponent(
                    String(id)
