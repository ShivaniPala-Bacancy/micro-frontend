...
export const ProductStatusType = {
    Created: 'created' as ProductStatusType,
    PendingActive: 'pendingActive' as ProductStatusType,
    Cancelled: 'cancelled' as ProductStatusType,
    Active: 'active' as ProductStatusType,
    PendingTerminate: 'pendingTerminate' as ProductStatusType,
    Terminated: 'terminated' as ProductStatusType,
    Suspended: 'suspended' as ProductStatusType,
    Aborted: 'aborted ' as ProductStatusType
};
