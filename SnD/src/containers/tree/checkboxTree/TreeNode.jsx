...
class TreeNode extends React.Component {
    ...
    renderLabel() {
        const { label, showCheckbox, showNodeIcon, icon } = this.props;
    ...
    render() {
        ...
        const nodeClass = `rct-node ${isLeaf ? 'rct-node-leaf' : 'rct-node-parent'
            } ${!isLeaf && expanded ? 'rct-node-expanded' : ''} ${!isLeaf && !expanded ? 'rct-node-collapsed' : ''
