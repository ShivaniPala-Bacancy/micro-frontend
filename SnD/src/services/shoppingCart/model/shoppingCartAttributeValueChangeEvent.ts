 ...
 */
import {ShoppingCartAttributeValueChangeEventPayload} from './shoppingCartAttributeValueChangeEventPayload';

/**
 * The notification data structure
 */
export interface ShoppingCartAttributeValueChangeEvent {
    /**
