...
export const ProductOrderStateType = {
    Acknowledged: 'acknowledged' as ProductOrderStateType,
    Rejected: 'rejected' as ProductOrderStateType,
    L1Approve: 'L1Approve' as ProductOrderStateType,
    L2Approve: 'L2Approve' as ProductOrderStateType,
    partialL2Approve: 'partialL2Approve' as ProductOrderStateType,
    Pending: 'pending' as ProductOrderStateType,
    Held: 'held' as ProductOrderStateType,
    InProgress: 'inProgress' as ProductOrderStateType,
    Cancelled: 'cancelled' as ProductOrderStateType,
    Completed: 'completed' as ProductOrderStateType,
    Failed: 'failed' as ProductOrderStateType,
    Partial: 'partial' as ProductOrderStateType,
    AssessingCancellation: 'assessingCancellation' as ProductOrderStateType,
    PendingCancellation: 'pendingCancellation' as ProductOrderStateType,
    partialAllocated: 'partialAllocated' as ProductOrderStateType,
    partialAccepted: 'partialAccepted' as ProductOrderStateType,
    dispatched: 'dispatched' as ProductOrderStateType,
};
