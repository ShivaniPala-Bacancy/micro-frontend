 ...
 */
export type OrderItemActionType = 'add' | 'modify' | 'delete' | 'noChange';

export const OrderItemActionType = {
    Add: 'add' as OrderItemActionType,
    Modify: 'modify' as OrderItemActionType,
    Delete: 'delete' as OrderItemActionType,
    NoChange: 'noChange' as OrderItemActionType
};
