...
export default class RegisterSkimService {
     ...
     */
    public createRegisterSkims(
        registerSkim: RegisterSkim,
        observe?: 'body',
        headers?: Headers
    ): Observable<RegisterSkim>;
    public createRegisterSkims(
        registerSkim: RegisterSkim,
        observe?: 'response',
        headers?: Headers
    ): Observable<HttpResponse<RegisterSkim>>;
    public createRegisterSkims(
        registerSkim: RegisterSkim,
        observe: any = 'body',
        headers: Headers = {}
        ...
        const response: Observable<HttpResponse<RegisterSkim>> =
            this.httpClient.post(
                `${this.APIConfiguration.basePath}/registerSkims`,
                registerSkim as any,
                headers
            );
        if (observe === 'body') {
    ...
    public deleteRegisterSkim(
        ...
        const response: Observable<HttpResponse<RegisterSkim>> =
            this.httpClient.delete(
                ...
                }/registerSkims/${encodeURIComponent(
                    String(skimId)
                )}` as any,
                headers
            );
     ...
     */
    public getRegisterSkim(
        skimId: string,
        current?: boolean,
        observe?: 'body',
        headers?: Headers
    ): Observable<Array<RegisterSkim>>;
    public getRegisterSkim(
        skimId: string,
        current?: boolean,
        observe?: 'response',
        headers?: Headers
    ): Observable<HttpResponse<Array<RegisterSkim>>>;
    public getRegisterSkim(
        skimId: string,
        current?: boolean,
        observe: any = 'body',
        ...
        const response: Observable<HttpResponse<Array<RegisterSkim>>> =
            this.httpClient.get(
                `${
                    this.APIConfiguration.basePath
                }/registerSkims/${encodeURIComponent(
    ...
    public listRegisterSkims(
        ...
        const response: Observable<HttpResponse<Array<RegisterSkim>>> =
            this.httpClient.get(
                `${
                    this.APIConfiguration.basePath
                }/registerSkims?sort=-skimDateTime&${queryParameters.join(
                    '&'
                )}` as any,
                headers
            );
